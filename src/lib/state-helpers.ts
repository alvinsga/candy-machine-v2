...
export async function getCandyMachineState(candyMachineId: web3.PublicKey, provider: Provider) {
	try {
...
export async function getUserBalance(walletPublicKey: string, connection: Connection) {
